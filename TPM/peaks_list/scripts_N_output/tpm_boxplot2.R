...
gm12878_taf1_exclu_yy1_genes <- extract_promoter_genes("./peaks_list/gm12878_taf1_exclu_yy1_peaks.csv")
gm12878_yy1_com_taf1_genes <- extract_promoter_genes("./peaks_list/gm12878_yy1_com_taf1_peaks.csv")
gm12878_yy1_exclu_taf1_genes <- extract_promoter_genes("./peaks_list/gm12878_yy1_exclu_taf1_peaks.csv")
...
# Reshape Data for plotting (order: `yy1_exclu`, `taf1_exclu`, `yy1_com`)
