...
h1_hesc_taf1_exclu_yy1_genes <- read.csv("./peaks_list/h1_hesc_taf1_exclu_yy1_peaks.csv", header=TRUE, sep=",")$geneName
h1_hesc_promo_taf1_exclu_yy1_genes <- extract_promoter_genes("./peaks_list/h1_hesc_taf1_exclu_yy1_peaks.csv")
h1_hesc_yy1_com_taf1_genes <- read.csv("./peaks_list/h1_hesc_yy1_com_taf1_peaks.csv", header=TRUE, sep=",")$geneName
h1_hesc_promo_yy1_com_taf1_genes <- extract_promoter_genes("./peaks_list/h1_hesc_yy1_com_taf1_peaks.csv")
h1_hesc_yy1_exclu_taf1_genes <- read.csv("./peaks_list/h1_hesc_yy1_exclu_taf1_peaks.csv", header=TRUE, sep=",")$geneName
h1_hesc_promo_yy1_exclu_taf1_genes <- extract_promoter_genes("./peaks_list/h1_hesc_yy1_exclu_taf1_peaks.csv")

# Assigning the files to a list
files_H1_hESC <- c(
  "./salmon_out_H1_hESC/salmon_output_ENCLB029TLD/quant.sf",
...
all_subsets <- list(
  subset_data(final_tpm_H1_hESC, h1_hesc_yy1_exclu_taf1_genes),
  subset_data(final_tpm_H1_hESC, h1_hesc_promo_yy1_exclu_taf1_genes),
  subset_data(final_tpm_H1_hESC, h1_hesc_taf1_exclu_yy1_genes),
  subset_data(final_tpm_H1_hESC, h1_hesc_promo_taf1_exclu_yy1_genes),
  subset_data(final_tpm_H1_hESC, h1_hesc_yy1_com_taf1_genes),
  subset_data(final_tpm_H1_hESC, h1_hesc_promo_yy1_com_taf1_genes)
)

# Update the gene list names without the "h1_hesc_" prefix
gene_list_names <- c(
...
p <- ggplot(df_for_plot, aes(x = gene_list, y = avg_expression)) +
  ...
  theme_minimal() +
  labs(title = "TPM Distribution across gene related to binding sites of YY1, TAF1 in H1-hESC",
       x = "Gene Group",
       y = "TPM (Log Scale)") +
...
# Generate statistical summary for each subset using the corrected variable names
summary_yy1_exclu_taf1 <- summarize_subset(subset_data(final_tpm_H1_hESC, h1_hesc_yy1_exclu_taf1_genes))
summary_promo_yy1_exclu_taf1 <- summarize_subset(subset_data(final_tpm_H1_hESC, h1_hesc_promo_yy1_exclu_taf1_genes))
summary_taf1_exclu_yy1 <- summarize_subset(subset_data(final_tpm_H1_hESC, h1_hesc_taf1_exclu_yy1_genes))
summary_promo_taf1_exclu_yy1 <- summarize_subset(subset_data(final_tpm_H1_hESC, h1_hesc_promo_taf1_exclu_yy1_genes))
summary_yy1_com_taf1 <- summarize_subset(subset_data(final_tpm_H1_hESC, h1_hesc_yy1_com_taf1_genes))
summary_promo_yy1_com_taf1 <- summarize_subset(subset_data(final_tpm_H1_hESC, h1_hesc_promo_yy1_com_taf1_genes))
